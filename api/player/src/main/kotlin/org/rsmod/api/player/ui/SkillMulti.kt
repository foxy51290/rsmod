...
public object SkillMulti {
    /**
     * Interface 270's option slots begin at `270:14`.
     *
     * These are resolved by packed id rather than by name. `.data/symbols/component.sym` names
     * `270:14` as `skillmulti:a`; later option components are resolved by packed id so the dialog
     * does not depend on every slot having a symbol name.
     */
    public const val FIRST_OPTION_COMPONENT: Int = 14
